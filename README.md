...
A real game of Texas Hold'em against AI opponents, with a coach explaining your decisions as you make them.

- **Pick your table size** — 4 to 8 players.
- **Pick your difficulty** — 10 levels, from total beginner to shark.
- **Realistic opponents** — each AI is given a fixed personality (tight, aggressive, loose, calling station, maniac, etc.), modelled on real player types, not random behaviour.
