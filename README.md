...
- **The opponents aren't AI, they're proper logic.** No machine learning here, each one runs hand strength maths (preflop charts, live equity simulation) through a fixed personality (tight, aggressive, loose, calling station, and maniac) modelled on real player type research.
